...
export default function Header() {
  ...
  return (
    ...
    >
      <div className="mx-auto flex max-w-[1280px] items-center justify-between  dark:bg-black/6 bg-white/6 backdrop-blur-lg border border-white/8 px-3 py-2 md:px-7 md:py-4 lg:px-10 lg:py-5 rounded-full">
        <div className="w-1/5">
          <Link
            href="/"
            className="gap-3 font-bold mb-0 text-white text-[18px] md:text-2xl lg:text-3xl ml-3 flex items-center"
          >
            <Image
              src="/logo-main.png"
